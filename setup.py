...
def main():
    ...
    setup(
        ...
        description=("Python utilities used for tracking the execution of callables in Python"),
        include_package_data=True,
        install_requires=install_requirements,
        keywords=["python", "libraries", "execution", "profiling"],
        license="MIT",
        long_description=readme,
        long_description_content_type='text/markdown',
        name="ctodd-python-lib-execution",
        packages=packages,
        project_urls={},
        python_requires=">3.6",
        setup_requires=setup_requirements,
        tests_require=test_requirements,
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-execution",
        version=version,
    )
